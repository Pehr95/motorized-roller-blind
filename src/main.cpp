...
#define INA219_SDA_PIN 6 // Change this to your desired SDA pin
#define INA219_SCL_PIN 7 // Change this to your desired SCL pin
...
void loop() {
  ...
  if(!setupDone) {
    delay(2000);
    Serial.println("Setting up INA219");
    if (!ina219.begin()) {
